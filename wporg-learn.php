<?php
/**
 * Plugin name: WP Training Team: WordPress.org Customizations
 * Description: Provides general customizations for the Training Team's presence on WordPress.org
 * Version:     0.1.0
